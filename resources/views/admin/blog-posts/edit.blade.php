    ...
    <div class="card-body">
        ...
        <fieldset class="col-lg-6">
            ...
            <div class="text-center mb-5">
                @if($post->photo_filename && \Storage::disk('public')->exists('/blog-posts-images/' . $post->photo_filename))
                <img 
                    class="img-fluid img-thumbnail" 
                    src="{{\Storage::disk('public')->url('/blog-posts-images/' . $post->photo_filename)}}" 
                    alt="placeholder">
                @else
                <img class="img-fluid img-thumbnail" src="http://via.placeholder.com/640x480" alt="blog image">
                @endif
