...
<!--                          <div class="form-group">
				...
				<input value="{{old('fa_icon', $tag->fa_icon)}}" name="fa_icon" placeholder="Enter fa_icon" aria-describedby="titleHelpBlock" required="required" class="form-control here" type="text"> 
