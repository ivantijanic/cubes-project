...
<h1>{{__('front.add')}} {{__('front.first_blog')}} {{__('front.first_category')}}</h1>
<hr>			
@include('admin.global-partials.system-messages')
<div class="card mb-3">
    <div class="card-header">
        <i class="fa fa-table"></i> {{__('front.add')}} {{__('front.first_blog')}} {{__('front.first_category')}}
    </div>
    <div class="card-body">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input name="title" placeholder="Enter Category" required class="form-control here" type="text" value="{{old('title')}}"> 
                @if($errors->has('title'))
